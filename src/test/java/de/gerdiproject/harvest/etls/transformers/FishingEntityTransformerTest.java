...
/**
 * This class provides Unit Tests the {@linkplain FishingEntityTransformer}.
 *
 * @author Robin Weiss
 */
public class FishingEntityTransformerTest extends AbstractSeaAroundUsTransformerTest<FishingEntityVO>
{
    @Override
