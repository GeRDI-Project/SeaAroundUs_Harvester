...
/**
 * This harvester harvests all Fishing Entities of SeaAroundUs. <br>
...
public class FishingEntityRegionHarvester extends AbstractListHarvester<SauFishingEntityReduced>
{
    ...
    private final static Type FISHING_ENTITY_RESPONSE_TYPE = new TypeToken<GenericResponse<SauFishingEntityRegion>>()
    {
    } .getType();


    /**
     * Simple constructor that initializes the super class with Fishing Entity
     * parameters.
     */
    ...
    protected Collection<SauFishingEntityReduced> loadEntries()
    {
        ...
        String apiUrl = SeaAroundUsDataCiteUtils.instance().getAllRegionsUrl(
                            SeaAroundUsRegionConstants.REGION_FISHING_ENTITY.urlName);
        TypeToken<GenericResponse<List<SauFishingEntityReduced>>> typeToken =
        new TypeToken<GenericResponse<List<SauFishingEntityReduced>>>() {
        };
        GenericResponse<List<SauFishingEntityReduced>> allFishingEntities =
            httpRequester.getObjectFromUrl(apiUrl, typeToken.getType());
    ...
    protected List<IDocument> harvestEntry(SauFishingEntityReduced entry)
    {
        ...
        // add region details
        GenericResponse<SauFishingEntityRegion> regionObjectResponse =
            httpRequester.getObjectFromUrl(apiUrl, FISHING_ENTITY_RESPONSE_TYPE);
    ...
    private List<WebLink> createWebLinks(SauFishingEntityRegion regionObject)
    {
        ...
        // catches
        List<WebLink> catchLinks = SeaAroundUsDataCiteUtils.instance().createCatchLinks(
        ...
        // Country Profile
        WebLink countryLink = new WebLink(
            String.format(
        ...
        // Fisheries Subsidies
        WebLink fisherySubsidiesLink = new WebLink(
    ...
    {
        List<ResearchData> files = SeaAroundUsDataCiteUtils.instance().createCatchFiles(
                                       SeaAroundUsRegionConstants.FISHING_ENTITY_PARAMS,
                                       regionId,
                                       regionName);
        return files;
