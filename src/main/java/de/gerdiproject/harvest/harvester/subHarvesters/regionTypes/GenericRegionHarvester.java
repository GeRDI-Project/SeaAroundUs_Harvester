...
public class GenericRegionHarvester extends AbstractJsonArrayHarvester
{
     ...
     * @param regionType the type of the regions that are to be harvested
     * @param dimensions the dimensions that are available for each region
    ...
    public GenericRegionHarvester( Entry regionType, Entry[] dimensions, UrlVO urls, int numberOfDocumentsPerEntry )
    {
        ...
        this.name = String.format( "%C%sHarvester", regionType.urlName.charAt( 0 ), regionType.urlName.substring( 1 ) );
        this.documentsPerEntry = 3 + dimensions.length * MEASURES.length;
    }
    ...
    protected IJsonObject createPrimaryProductionDocument( int regionId, String regionName, IJsonArray geoData, List<String> defaultTags )
    {
    ...
    protected IJsonObject createStockStatusDocument( int regionId, String regionName, IJsonArray geoData, List<String> defaultTags )
    {
    ...
    protected IJsonObject createMarineTrophicIndexDocument( int regionId, String regionName, IJsonArray geoData, List<String> defaultTags )
    {
    ...
    protected IJsonObject createDocument( String label, String apiUrl, String viewUrl, IJsonArray geoData, List<String> defaultTags, String arrayKey )
    {
    ...
    protected final IJsonObject createDocument( String label, String apiUrl, String viewUrl, IJsonArray geoData, List<String> defaultTags )
    {
    ...
    protected String getRegionName( IJsonObject regionObject )
    {
        ...
        // check if region name is just an abbreviation, add the complete name as well
