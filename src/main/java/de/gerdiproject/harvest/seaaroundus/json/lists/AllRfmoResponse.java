...
import de.gerdiproject.harvest.seaaroundus.json.lists.AllRfmoResponse.RfmoProperties;
 ...
 * @author Robin Weiss
 */
public final class AllRfmoResponse extends FeatureCollectionResponse<RfmoProperties>
{
    public static class RfmoProperties
    {
