...
import de.gerdiproject.harvest.seaaroundus.json.MaricultureResponse.Mariculture;
 ...
 * @author Robin Weiss
 */
public final class MaricultureResponse extends GenericResponse<List<Mariculture>>
{
    public static final class Mariculture
    {
