...
import de.gerdiproject.harvest.seaaroundus.json.CountryResponse.CountryDetailed;
import de.gerdiproject.harvest.seaaroundus.json.generic.GenericResponse;

/**
 * This class represents a JSON object that is part of the response to a Seaaroundus country request.
 * <br>e.g. see http://api.seaaroundus.org/api/v1/country/120
 *
 * @author Robin Weiss
 */
public final class CountryResponse extends GenericResponse<CountryDetailed>
{
    public static final class CountryDetailed
    {
        private String cia;
        ...
        public List<CountryNgo> getNgo()
        {
            return ngo;
        }


        public void setNgo(List<CountryNgo> value)
        {
            this.ngo = value;
        }
