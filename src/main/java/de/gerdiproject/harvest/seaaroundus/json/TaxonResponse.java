...
import de.gerdiproject.harvest.seaaroundus.json.TaxonResponse.TaxonDetailed;
 ...
 * @author Robin Weiss
 */
public final class TaxonResponse extends GenericResponse<TaxonDetailed>
{
    public static final class TaxonDetailed
    {
    	private double k;
    	private double tl;
    	private int woo;
    	...
    	private TaxonHabitatIndex habitatIndex;
    	...
    	public TaxonHabitatIndex getHabitatIndex()
    	{
    		return habitatIndex;
    	}


    	public void setHabitatIndex(TaxonHabitatIndex value)
    	{
    ...
    public static class TaxonHabitatIndex
    {
