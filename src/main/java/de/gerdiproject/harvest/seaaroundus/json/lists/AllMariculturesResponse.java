 ...
 *  under the License.
 */
package de.gerdiproject.harvest.seaaroundus.json.lists;

import com.google.gson.annotations.SerializedName;

import de.gerdiproject.harvest.seaaroundus.json.generic.FeatureCollectionResponse;
import de.gerdiproject.harvest.seaaroundus.json.lists.AllMariculturesResponse.MaricultureProperties;
 ...
 * @author Robin Weiss
 */
public final class AllMariculturesResponse extends FeatureCollectionResponse<MaricultureProperties>
{
    public static class MaricultureProperties
    {
