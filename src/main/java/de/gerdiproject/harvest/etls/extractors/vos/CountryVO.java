...
/**
 * This value object contains extracted country data.
 *
 * @author Robin Weiss
 */
@Value
...
{
    private final GenericResponse<SauCountry> response;
    private final List<Feature<SauCountryProperties>> subRegions;
}
